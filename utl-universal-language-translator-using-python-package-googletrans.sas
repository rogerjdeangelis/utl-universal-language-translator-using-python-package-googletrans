...
3606   ",return=english);
MLOGIC(UTL_SUBMIT_PY64):  Parameter PGM has value "import pyperclip;from googletrans import Translator;translator = Translator();text = translator.translate('bonjour
...
SYMBOLGEN:  Macro variable PGM resolves to "import pyperclip;from googletrans import Translator;translator = Translator();text = translator.translate('bonjour madame',
